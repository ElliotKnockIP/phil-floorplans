...
export const ObjectTypeUtils = {
  ...
  isDrawingObject: (obj) => {
    ...
    if (obj.isConnectionSegment || obj.isNetworkSplitPoint || obj.isNetworkConnection || obj.isSegmentDistanceLabel || obj.isConnectionCustomLabel) return false;
    if (obj.type === "circle" && obj.fill === "#f8794b" && obj.radius < 30 && !obj.isWallCircle) return false;
    return true;
  },
  isManagedObject: (obj) => {
    return ObjectTypeUtils.isDevice(obj) || (obj.type === "text" && obj.isDeviceLabel) || (obj.type === "polygon" && obj.fill?.includes("165, 155, 155")) || obj.isResizeIcon === true || (obj.type === "circle" && obj.fill === "#f8794b" && obj.radius < 30 && !obj.isWallCircle) || obj.isCoverage === true || obj.isSegmentDistanceLabel || obj.isConnectionCustomLabel;
  },
