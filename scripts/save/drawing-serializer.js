...
class OptimizedDrawingObjectSerializer {
  ...
  // Saves all risk polygons to JSON
  serializeRisks() {
  ...
  // Loads saved risks onto canvas
  async loadRisks(risksData) {
    await this.loadPolygonTextData("risks", risksData);
