...
// Sets up the polygon popover that shows when a zone, room, or risk is selected
(function () {
  ...
  // Shows zone, room, or risk properties section based on type
  ...
  const basePopover = createPopoverBase("polygon-popover", {
    ...
    customOpenPopover: function(kind, polygon, baseOpen) {
      ...
      const titles = { zone: "Zone Properties", room: "Room Properties", risk: "Risk Properties" };
    ...
    installIntercepts: {
      ...
      shouldIntercept: (deviceType) => {
        return deviceType === "zone-polygon" || deviceType === "room-polygon" || deviceType === "risk-polygon";
      },
      waitFor: () => {
      ...
      onShowDeviceProperties: function(deviceType, textObject, polygon, fourth, originalShow) {
        if (deviceType === "zone-polygon" || deviceType === "room-polygon" || deviceType === "risk-polygon") {
          ...
          const kind = deviceType === "room-polygon" ? "room" : deviceType === "risk-polygon" ? "risk" : "zone";
