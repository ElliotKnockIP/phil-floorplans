...
// Single source of truth for all device type mappings

// Camera types that support coverage areas
export const CAMERA_TYPES = ["fixed-camera.png", "box-camera.png", "dome-camera.png", "ptz-camera.png", "bullet-camera.png", "thermal-camera.png"];
...
// User-friendly category labels for UI display
...
// Device types that support channel numbering like panels and recorders
export const PANEL_DEVICE_TYPES = ["panel-control.png", "access-panel.png", "interface-unit.png", "dvr.png", "nvr.png"];

// Mapping of device types to their image file paths
...
// Map from filename to full path for serialization
export const IMAGE_MAP = Object.fromEntries(CAMERA_TYPES.map((type) => [type, `./images/devices/${type}`]));

// Checks if a given device type string represents a camera
...
// Determines the system category for a specific device object
...
// Checks if a device is a panel or recorder type
...
// Checks if two device categories are allowed to be connected
