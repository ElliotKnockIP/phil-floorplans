// floor-manager.js - Multi-Floor System
import { FloorSerializer } from "../save/floor-save.js";
import { FloorUI } from "./floor-ui.js";
...
export class FloorManager {
  ...
  createNewFloor(floorNumber) {
    const emptyFloorState = {
      ...
      background: null,
      settings: { pixelsPerMeter: 17.5, zoom: 1, viewportTransform: [1, 0, 0, 1, 0, 0], defaultDeviceIconSize: 30, ...this.serializer.getCurrentGlobalSettings() },
