...
window.onload = function () {
  ...
  // Expose globally for cross-module access (e.g., mobile gestures)
  ...
  window.canvasSnapping = snappingAPI; // expose for clearing after loads

  // Initialize context menu and hover tooltip
  initContextMenu(fabricCanvas);
  ...
  // Initialize topology builder modal integration
  ...
  window.debugTopology = () => topologyManager.debugConnections();

  // Dispatch canvas initialized event for other modules
  document.dispatchEvent(new CustomEvent('canvas:initialized', { 
